...
print(chk.Attack)
ans = chk.head(400).Legendary.sum() - chk.iloc[400:799].Legendary.sum()
print(ans)

#02Type 1 컬럼의 종류에 따른 Total 컬럼의 평균값을 내림차순 정렬했을때 상위 3번째 Type 1은 무엇인가?
...
chk = df.dropna()
ans = chk.iloc[0:int(len(chk)*0.6)].Defense.quantile(0.25)
print(ans)
