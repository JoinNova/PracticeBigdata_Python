...
print('test rf roc_score :', roc_auc_score(y_test, pred[:, 1]))

ada.fit(x_train, y_train)
ada_pred = ada.predict_proba(x_test)
print('test ada roc_score : ', roc_auc_score(y_test, pred[:, 1]))
...
rf_submission['predict'] = rf_test_pred[:, 1]
...
rf_submission.to_csv('sony01_002_25_rf.csv', index = False)
print('ada submission file \n', ada_submission.head(7))
ada_submission.to_csv('sony01_002_25_ada.csv', index = False)
