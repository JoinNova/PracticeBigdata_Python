...
rf_submission = pd.DataFrame({'ID':test.id, 'stroke':rf_test_pred[:, 1]})
...
rf_submission.to_csv('sony02_002_99_rf.csv', index = False)

print('ada submission file \n', ada_submission.head(7))
ada_submission.to_csv('sony02_002_99_ada.csv', index = False)
